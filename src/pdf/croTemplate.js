...
function build({ job, settings, docNumber }) {
  ...
  doc.autoTable({
    ...
    body: [
      ...
      ['Pickup Terminal', firstC.pickup_terminal || ''],
      ['Delivery Location', firstC.delivery_location || ''],
      ['Transporter', firstC.transporter || ''],
      ['Transporter Contact', firstC.transporter_contact || ''],
      ['Pickup Contact', firstC.pickup_contact_person || ''],
      ['Delivery Contact', firstC.delivery_contact_person || ''],
      ['Pickup Instructions', firstC.pickup_instructions || ''],
      ['Delivery Instructions', firstC.delivery_instructions || ''],
